...
SIDE_ALERT_MIN_REPLACE_SECONDS = float(os.getenv("AB_SIDE_ALERT_MIN_REPLACE_SECONDS", "2.4"))
...
RELAX_QUERY_TIERS = [
    ...
    [
        ...
        "youTube keeps copyrighting my videos rat",
